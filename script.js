...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Sayang", "Uda mau nanya sama Adiak?", "question").then(function () {
    Swal.fire("jujur ya!").then(function () {
      Swal.fire("Don't Lie, OK!!", "", "error").then(function () {
        ...
        const {
          ...
          title: 'Masukin nama Adiak',
          input: 'text',
          inputLabel: '',
          showCancelButton: true,
          inputValidator: (value) => {
            if (!value) {
              return 'Isi dulu yank :('
            } else {
              nama = value;
            }
          }
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`kalau kangen coba chat, ${sender} juga kangen sama ${nama},Semangat Yah kerjanya Sayang :((`).then(function () {
                          Swal.fire('Terakhir yank').then(function () {
                            Swal.fire('Coba klik ikon hati di paling bawah dong')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('Jahat banget emang ga kangen sama ${sender}', '', 'error').then(function () {
